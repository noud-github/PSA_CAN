...
MCP_CAN CAN0(A5);     // Set CS to pin 10
...
unsigned char txBuf[6] = {0b00000000,0b00000000,0b00101010,0b11111111,0b11111111,0b11111101};
...
void loop()
{
  ...
  for(byte j = 0; j<=0b111; j++){
    ...
    byte sndStat = CAN0.sendMsgBuf(0x0E1, 0, 7, txBuf);
    if(sndStat == CAN_OK){
